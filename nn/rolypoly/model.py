...
@keras.utils.register_keras_serializable()
class ROLYPOLY_reg(keras.Model):
    def __init__(self, num_layers=10, num_nodes=2000, input_dim=9, **kwargs):
        super(ROLYPOLY_reg, self).__init__(**kwargs)
...
def load(model_path):
    return keras.models.load_model(model_path, custom_objects={'ROLYPOLY_reg': ROLYPOLY_reg, 'swish_activation': swish_activation})