...
def calculate_2(l1: MomentumObject4D, l2: MomentumObject4D, l3: MomentumObject4D, l4: MomentumObject4D) -> np.ndarray:
    """
    Calculates kinematic variables cos 𝜃∗, cos 𝜃1, cos 𝜃2, 𝜙1 ,𝜙, mZ1 and mZ2. 
    Angles used are described in https://journals.aps.org/prd/pdf/10.1103/PhysRevD.86.095031.
    ...
    return np.array([cth_star, cth1, cth2, phi1, phi, Z1.mass, Z2.mass, m4l, y4l]).T
